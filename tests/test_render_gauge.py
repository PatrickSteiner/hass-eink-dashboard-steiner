...
class TestRenderGauge:
    ...
    def test_gauge_per_element_font_size_overrides(self) -> None:
        # name_font_size / value_font_size / unit_font_size set the
        # exact px font-size of each text element.
        svg = render_widget_svg(
            self._base_widget(
    ...
    def test_gauge_per_element_style_bold(self) -> None:
        # name_style/value_style/unit_style="bold" render each text
        # element bold.
        svg = render_widget_svg(
            self._base_widget(
